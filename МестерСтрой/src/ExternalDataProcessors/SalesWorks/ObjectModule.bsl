...
Процедура SalOuts(Настройки)
	...
	Пока ВыборкаХозяйственнаяОперация.Следующий() Цикл
		...
		Пока ВыборкаДокументПродажи.Следующий() Цикл
			...
			ЗаписатьРеквизитXML(ЗаписьXML, "INVOICE_NO", 			ВыборкаДокументПродажи.ДокументПродажиНомер); // TODO: Добавить префикс по типу и дате документа
			...
			ЗаписатьРеквизитXML(ЗаписьXML, "MERCH_CODE", 			"ВнешнийКодТорговогоПредставители"); // TODO: ВнешнийКодТорговогоПредставители
			ЗаписатьРеквизитXML(ЗаписьXML, "DATE", 					XMLСтрока(ВыборкаДокументПродажи.ДокументПродажиДата));
			ЗаписатьРеквизитXML(ЗаписьXML, "ORDER_NO", 				"0"); // TODO: Идентификатор заказа
			ЗаписатьРеквизитXML(ЗаписьXML, "DATETO", 				XMLСтрока(ВыборкаДокументПродажи.ДокументПродажиДата));
			ЗаписатьРеквизитXML(ЗаписьXML, "PARAM1", 				"0");
			...
			ЗаписатьРеквизитXML(ЗаписьXML, "VATCALCMOD", 			"1"); // TODO: Режим расчета цен (с НДС / без НДС) 0 – цены без НДС 1 – цены с НДС 2 – цены с НДС = 0
			
			ЗаписатьРеквизитXML(ЗаписьXML, "STATUS", 				ВыборкаДокументПродажи.Статус); // TODO: Статус накладной. 2 активная 9  непроведенная
			...
			ЗаписатьРеквизитXML(ЗаписьXML, "ORDER_NO", 				"0"); // TODO: Идентификатор заказа
			ЗаписатьРеквизитXML(ЗаписьXML, "QTY", 					Формат(ВыборкаДетальныеЗаписи.Количество, "ЧЦ=14; ЧДЦ=3; ЧРД=.; ЧГ=;")); // TODO: положитеьное или отрицательное
			//ЗаписатьРеквизитXML(ЗаписьXML, "VAT", 					Формат(ВыборкаДетальныеЗаписи.СтавкаНДСЧислом, "ЧЦ=5; ЧДЦ=2; ЧРД=.; ЧГ=;"));

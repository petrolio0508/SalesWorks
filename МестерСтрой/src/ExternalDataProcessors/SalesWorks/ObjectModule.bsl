...
Процедура SalOuts(Настройки)
	...
	Пока ВыборкаХозяйственнаяОперация.Следующий() Цикл
		...
		Пока ВыборкаДокументПродажи.Следующий() Цикл
			...
			ЗаписатьРеквизитXML(ЗаписьXML, "ORDER_NO", 				СформироватьНомерЗаказа(ВыборкаДокументПродажи.ЗаказКлиентаНомер, ВыборкаДокументПродажи.ЗаказКлиентаДата)); // TODO: Идентификатор заказа

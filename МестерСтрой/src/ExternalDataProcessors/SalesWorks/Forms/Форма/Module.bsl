...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьРеквизитФормыИзНатроек(Настройки, "ВидЦены");
		
	ЗаполнитьРеквизитФормыИзНатроек(Настройки, "FTPВыгружать");
	...
	ЗаполнитьРеквизитФормыИзНатроек(Настройки, "ПользовательПоУмолчанию");
...
&НаКлиенте
Процедура ТестРегламентаПолнаяВыгрузка(Команда)
	ТестРегламентаПолнаяВыгрузкаНаСервере();
КонецПроцедуры

&НаКлиенте
Процедура ТестРегламентаЧастичнаяВыгрузка(Команда)
	ТестРегламентаЧастичнаяВыгрузкаНаСервере();
КонецПроцедуры
#КонецОбласти
...
Процедура СохранитьНастройкиНаСервере()
	...
	Настройки.Вставить("ПользовательПоУмолчанию", ПользовательПоУмолчанию);
...
Процедура ВыгрузитьДанныеНаСервере()
	...
	ОбъектОбработки().ВыгрузитьВсеДанные(Период.ДатаНачала, Период.ДатаОкончания);
	
КонецПроцедуры


&НаСервере
Процедура ТестРегламентаПолнаяВыгрузкаНаСервере()
	
	ОбъектОбработки().ВыполнитьКоманду("ХЕНКЕЛЬ_ПОЛНАЯ_ВЫГРУЗКА");

КонецПроцедуры

&НаСервере
Процедура ТестРегламентаЧастичнаяВыгрузкаНаСервере()
	
	ОбъектОбработки().ВыполнитьКоманду("ХЕНКЕЛЬ_ЧАСТИЧНАЯ_ВЫГРУЗКА");
